...
from modules.golang.scanner import Scanner
...
async def publish(name: str, payload: str, proxy: str = "https://proxy.golang.org", dry_run: bool = True) -> None:
    """Publish Go module source if unclaimed."""
    ...
    with temporary_directory("go") as tmp:
        (tmp / "go.mod").write_text(payload)
